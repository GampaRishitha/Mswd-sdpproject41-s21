...
const col=db.collection('Regusers')
const col2 = db.collection('Surveyform')
const col3 = db.collection('Studentinfo')
...
app.post('/appointment/book', async (req, res) => {
    try {
        ...
        const bookappointments = db.collection('bookappoint');
        client.connect()
...
app.put('/entryinfo', async(req, res)=>{
    console. log(req.body);
    var doc ={
    $set:{
...
app.get('/displaystudent',async(req,res)=>{
